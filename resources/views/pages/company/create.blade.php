            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="bg-white border border-4 rounded-lg shadow relative m-10">
                    ...
                    <div class="p-6 space-y-6">
                        <x-form :action="route('company.store')" method="POST">
                            <div class="grid grid-cols-3 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="name" id="name"
                                           ...
                                           placeholder="Name example" required value="{{ old('name') }}">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="email"
                                           class="text-sm font-medium text-gray-900 block mb-2">
                                    ...
                                    <input type="email" name="email" id="email"
                                           class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-indigo-700 focus:border-indigo-700 block w-full p-2.5"
                                           placeholder="Email example" required value="{{ old('email') }}">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="site_url" id="site_url"
                                           class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-indigo-700 focus:border-indigo-700 block w-full p-2.5"
                                           placeholder="Site URL example" required value="{{ old('site_url') }}">
                                </div>
                            </div>
                            <button
